...
function Intro (body, footer) {
  return html`
    <section class="Intro">
      <a href="/" rel="home" class="Intro-home">
      ...
      <div class="Intro-footer">
        ...
        <p class="Intro-social">
          ...
          <a class="Intro-link" target="_blank" rel="noopener noreferrer" href="https://instagram.com/codeandconspire">Instagram</a><br>
