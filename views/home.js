      ...
      <div class="View-intro">
        ${intro(html`
          <div>
            ...
            <p>We seek elegant technological solutions: code that is fast and design that works. Our work ranges from large-scale websites to popular open source projects and delightful mobile experiences.</p>
            <p>
...
function meta (state) {
  return {
    ...
    description: 'We are a group of digital experts in creating websites, applications and services of the highest quality.'
  }
}
