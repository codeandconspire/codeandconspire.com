      ...
      <div class="View-intro">
        ${intro(html`
          <div>
            ...
            <p>We innovate in the space where individuals meet technology. Finding the elegant mix of functional lovable design and code that is reliable and lightning fast.</p>
            <p>
