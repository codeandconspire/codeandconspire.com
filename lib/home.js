...
var content = [
  {
    ...
    img: { src: 'globalgoals.png', alt: 'Three stacked screenshots from The Global Goals website' }
  }, {
    label: 'Maktsalongen',
    id: 'lmn',
    ...
    img: { src: 'litemycketnu.jpg', alt: 'Portrait of Flora Wiström in the Litemycket.nu jacket' }
  }, {
    ...
    img: { src: 'quantifiedplanet.jpg', alt: 'Planet Earth, night time' }
  }, {
    light: true,
    ...
    img: { src: 'amnestyunfluencer.png', alt: 'Illustrated Twitter bots' }
  }, {
    label: 'Planet 15',
    id: 'planet15',
    ...
    img: { src: 'planet15.jpg', alt: 'Rendering of a planet created in the Planet 15 game' }
  }, {
    ...
    link: { text: 'More about Goalkeepers', href: 'https://www.gatesfoundation.org/goalkeepers' },
    img: { src: 'billgates.jpg', alt: 'Bill Gates on the Goalkeepers 2018 state' }
  }
]
