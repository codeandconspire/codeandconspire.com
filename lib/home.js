    ...
    <main class="View-container">
      <div class="View-main">
        ...
        <div class="View-body">
          ...
          <p>Read <strong>our manifest</strong> for positive and gratifying digital interactions.</p>
        </div>
        <div class="View-footer">
          <p>
            <a class="u-nowrap" href="https://www.google.se/maps/place/Alma/@59.3215566,18.0169478,13z/data=!4m8!1m2!2m1!1salma!3m4!1s0x465f9d5b00af1afd:0x44480b8d5d69a7c7!8m2!3d59.334149!4d18.077116?dcr=0">Nybrogatan 8, Stockholm</a><br>
            <a class="u-nowrap" href="mailto:hi@codeandconspire.com">hi@codeandconspire.com</a><br>
            <a class="u-nowrap" href="tel:+46735819750">+46 735 819 750</a>
          </p>
          <p class="View-social">
            <a class="u-nowrap" href="https://twitter.com/codeandconspire">Twitter</a><br>
            <a class="u-nowrap" href="https://github.com/codeandconspire">Github</a><br>
            <a class="u-nowrap" href="https://www.facebook.com/codeandconspire">Facebook</a>
          </p>
        </div>
      </div>
      ...
      <div class="View-scroll">
        ...
        <div class="View-poster">
          ${poster({key: 1, label: 'Project', title: 'The Global Goals', text: 'The go-to website for sustainable development, the award-winning website for The United Nations Global Goals. We did concept, design and code.'})}
        </div>
        <div class="View-poster">
          ${poster({key: 2, label: 'Project', title: 'Lite mycket nu?', text: 'En skola på sms som hjälper dig stå upp mot stress. Vi gjorde allt tekniskt.'})}
        </div>
        <div class="View-poster">
          ${poster({key: 3, label: 'Project', title: 'Real time data with Quantified Planet', text: 'We did branding, design, concept and code.'})}
        </div>
        <div class="View-poster">
          ${poster({key: 4, label: 'Project', title: 'Troll bot factory for the good guys', text: 'Amnesty International fighting trolls'})}
        </div>
        <div class="View-poster">
          ${poster({key: 5, label: 'Project', title: 'Play a game and help your city flourish', text: 'Planet 15'})}
        </div>
        <div class="View-poster">
          ${poster({key: 6, label: 'Project', title: 'Innovations in toiletpaper?!', text: 'Hempur'})}
        </div>
        <div class="View-poster">
          ${poster({key: 7, label: 'Project', title: 'Goalkeepers awards', text: 'Goalkeepers'})}
        </div>
      </div>
    </main>
  `
